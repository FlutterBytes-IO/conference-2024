	...
	({ handleClick }, ref) => {
		...
		return (
			...
			>
				<Link
					href="/"
					className="relative max-md:after:hidden after:absolute after:content-[''] after:left-full after:top-1/2 after:-translate-y-1/2 after:w-full after:overflow-hidden after:h-px after:bg-fbc_blue-100"
				>
					<Image
				...
				<div className="hidden md:flex items-center gap-x-3 relative before:max-md:hidden before:absolute before:content-[''] before:right-full before:top-1/2 before:-translate-y-1/2 before:w-[135%] before:h-px before:bg-fbc_blue-100">
